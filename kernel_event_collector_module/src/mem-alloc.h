...
#  define ec_mem_free(VALUE) __ec_mem_free(VALUE, __func__, __LINE__)
#  define ec_mem_put(VALUE) __ec_mem_free(VALUE, __func__, __LINE__)
#else
...
#  define ec_mem_free(VALUE) __ec_mem_free(VALUE, NULL, __LINE__)
#  define ec_mem_put(VALUE) __ec_mem_free(VALUE, NULL, __LINE__)
#endif
