...
extern pid_t ec_getpid(struct task_struct *task);
extern pid_t ec_gettid(struct task_struct *task);
extern pid_t ec_getppid(struct task_struct *task);
...
extern bool ec_is_task_valid(struct task_struct *task);
extern bool ec_is_task_alive(struct task_struct *task);
struct task_struct *ec_find_task(pid_t pid);
void ec_get_devinfo_from_task(struct task_struct *task, uint64_t *device, uint64_t *ino);
